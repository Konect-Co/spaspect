...
protected:
  Point2f* test_pixel_array[4] = { new Point2f(330,250), new Point2f(50,370), new Point2f(945,395), new Point2f(815,245) };
  Point2f* test_lonlat_array[4] = { new Point2f(-73.984976, 40.759271), new Point2f(-73.985132, 40.759316), 
    new Point2f(-73.985201, 40.759196), new Point2f(-73.985035,40.759104) };
...
protected:
  void test_pixel_to_lonlat(){
    ...
    CPPUNIT_ASSERT_DOUBLES_EQUAL(-73.98457242314669, (*lonlat_coordinates)[0]->x, 1e-2 );
    CPPUNIT_ASSERT_DOUBLES_EQUAL(40.75940737741828, (*lonlat_coordinates)[0]->y, 1e-2 );
  ...
  void test_lonlat_to_pixel() {
    ...
    CPPUNIT_ASSERT_DOUBLES_EQUAL(543.7754262271288, (*pixel_coordinates)[0]->x, 1e-2 );
    CPPUNIT_ASSERT_DOUBLES_EQUAL(248.17036212679892, (*pixel_coordinates)[0]->y, 1e-2 );
  ...
  void test_lonlat_to_3D() {
    ...
    CPPUNIT_ASSERT_DOUBLES_EQUAL(-7.90371999981943, (*_3D_coordinates)[0]->x, 1e-2 );
    CPPUNIT_ASSERT_DOUBLES_EQUAL(-0.7370845314884706, (*_3D_coordinates)[0]->y, 1e-2 );
